...
# -- Constatns ---------------------------------------------------------------
LLVM_14_LIB_PATH = '/usr/lib/llvm-14/lib/libclang-14.so.1'

# -- Path setup --------------------------------------------------------------
if os.path.isfile(LLVM_14_LIB_PATH):
    cl.Config.set_library_file(LLVM_14_LIB_PATH)
    cl.Config.set_library_path(LLVM_14_LIB_PATH)
